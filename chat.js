...
const firebaseConfig = {
  ...
  // Initialize Firebase
   firebase.initializeApp(firebaseConfig);
    ...
    leftSidebar.innerHTML = '<iframe src="https://wuscoadvertisement-485877.netlify.app/" style="width: 200px; padding: 0px; height: calc(100% - 10px); overflow:hidden;"></iframe>'; 
  ...
  create_right_sidebar() {
   ...
   // add your rules here enzo
    rules.innerHTML = `
      ...
      <li>Rule 3: No links to NSFW.</li>
      <li>Rule 4: Cussing is allowed, but no slurs.</li>
          `;
