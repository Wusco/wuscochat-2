...
const firebaseConfig = {
  ...
  // Initialize Firebase
   firebase.initializeApp(firebaseConfig);
    ...
    leftSidebar.innerHTML = '<iframe src="https://wuscoadvertisement-485877.netlify.app/" width="200px" height="calc(100% - 10px)" overflow="auto" position="fixed" top="100px" padding="20px"></iframe>'; 
